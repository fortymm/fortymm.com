defmodule FortymmWeb.Router do
  use FortymmWeb, :router

  import FortymmWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {FortymmWeb.Layouts, :root}
  ...
  scope "/", FortymmWeb do
    ...
    live "/matches/:id", MatchLive, :show
  end
  ...
  if Application.compile_env(:fortymm, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FortymmWeb.Telemetry
  ...
  scope "/", FortymmWeb do
    ...
    live_session :require_authenticated_user,
      ...
      live "/challenges/:slug", ChallengeLive, :show
